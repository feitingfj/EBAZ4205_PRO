...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ENET0_MII_RXD [ create_bd_port -dir I -from 3 -to 0 -type data ENET0_MII_RXD ]
  ...
  set ENET0_MII_TXD [ create_bd_port -dir O -from 3 -to 0 -type data ENET0_MII_TXD ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_MDIO_ETHERNET_0 [get_bd_intf_ports MDIO_ETHERNET] [get_bd_intf_pins processing_system7_0/MDIO_ETHERNET_0]
  ...
  connect_bd_net -net ENET0_MII_RXD [get_bd_ports ENET0_MII_RXD] [get_bd_pins processing_system7_0/ENET0_GMII_RXD]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_ports ENET0_MII_TXD] [get_bd_pins xlconcat_0/dout]
